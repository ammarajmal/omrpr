...
switch BF_filter
    ...
    case 'wi'
        f1 = 3.4; band = 0.01; fl = f1-band; fh = f1+band; 
        [b, a]=fir1(1200,[fl/fn fh/fn]); data = filtfilt(b,a,data1);
end
...
title('');ylabel('Amplitude(mm)');ylim([-1 1]);xlabel('Time (sec)');grid;xlim([0 60]);
